...
from datasets.willow_dataset import WillowDataset
...
def main():
    ...
    # load train data
    train = WillowDataset(train_path, train_range, img_height = 384, img_width = 512,
                             gaussian_noise=True,
    ...
    # load test data
    test = WillowDataset(train_path, test_range, img_height = 384, img_width = 512,
    ...
    if args.resume:
        ...
        npz_name = 'DualCenterProposalNetworkRes50ver2_willowdataset.npz'
