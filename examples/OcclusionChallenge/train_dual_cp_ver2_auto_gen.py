...
def main():
    ...
    parser.add_argument('--out', '-o', default='results/dual_cp_ver2_auto_gen',
    ...
    parser.add_argument('--background', '-bg', default='../../train_data/VOCdevkit/VOC2012/JPEGImages',
    ...
    # load train data
    train = DualCPNetAutoGenerateDataset(train_path, background_path, train_range,
    ...
    test = DualCPNetDataset(train_path, test_range, img_height = 480, img_width = 640,
                            metric_filter=output_scale + eps)
