...
def main():
    ...
    rgb_fpath_mask = os.path.join(data_basepath, 'test', '{0:0>2}', 'rgb', '{1:0>4}.png')
    depth_fpath_mask = os.path.join(data_basepath, 'test', '{0:0>2}', 'depth', '{1:0>4}.png')
    gt_poses_mask = os.path.join(data_basepath, 'test', '{0:0>2}','gt.yml')
    info_mask = os.path.join(data_basepath, 'test', '{0:0>2}','info.yml')
    gt_mask_dir = os.path.join(data_basepath, 'test', '{0:0>2}', 'mask')
    mask_fpath_mask = os.path.join(data_basepath, 'test', '{0:0>2}', 'mask', '{1:0>4}_{2:0>2}.png')
